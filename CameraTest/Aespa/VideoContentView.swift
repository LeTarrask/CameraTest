            ...
            VStack {
                ...
                ZStack {
                    ...
                    recordingButtonShape(width: 60).onTapGesture {
                        ...
                        case .photo: // TODO: - maybe create a third different kind of capture for this VM here, or in real implementation
                            viewModel.captureBracketedPhotos(count: bracketCount)
                        }
                    }
                }
            }
